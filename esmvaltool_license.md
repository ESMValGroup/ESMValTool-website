...
| ------------ |-------------|
| [Public license (users)](https://github.com/ESMValGroup/ESMValTool/blob/main/LICENSE) | License for ESMValTool that is released as open-source software under the Apache License, version 2.0. This license applies to users of the ESMValTool. |
