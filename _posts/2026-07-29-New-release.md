---
layout: post
title: ESMValTool v2.15.0
date: 2026-07-29
---

## ESMValTool v2.15.0 released!
...
* CMOR tables for CORDEX-CMIP6
* CORDEX-CMIP5 dataset fixes
* CORDEX-CMIP5 preprocessor and regridding support
     
#### ESMValTool:

* Preparation of recipes that are run by the Rapid Evaluation Framework (REF) for CMIP7.
* An option to install ESMValTool with minimal dependencies
* Use pixi to manage development environments see Install from source more information.
